    ...
    <div className="grid min-h-screen md:grid-cols-2">
      <div className="relative hidden flex-col justify-between bg-primary p-10 text-primary-foreground md:flex bg-paper-grain">
        ...
        <div>
          <div className="flex items-center gap-2">
            <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-saffron text-saffron-foreground font-display font-bold">
              स
            </div>
          ...
          <p className="mt-8 max-w-md font-display text-3xl leading-tight">
            “Pehli baar lagta hai mere paas ek aisi assistant hai jo sach mein samajhti hai mera
            business.”
          </p>
          <p className="mt-3 text-sm text-primary-foreground/70">
            — Priya, Sharma Saree House, Jaipur
          </p>
        </div>
      ...
      <div className="flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-sm">
          <Link
            to="/"
            className="mb-8 inline-flex items-center gap-2 text-sm text-muted-foreground hover:text-foreground md:hidden"
          >
            <ArrowLeft className="h-4 w-4" /> Back
          </Link>
          <h1 className="font-display text-3xl font-semibold">Welcome back</h1>
          <p className="mt-1 text-sm text-muted-foreground">Sign in to your Sarthi dashboard.</p>
...
function GoogleIcon() {
  return (
    <svg className="mr-2 h-4 w-4" viewBox="0 0 48 48">
      ...
      <path
        fill="#FF3D00"
        d="M6.3 14.7l6.6 4.8C14.7 16 19 12.5 24 12.5c2.9 0 5.6 1.1 7.6 2.9l5.7-5.7C33.6 6.4 29 4.5 24 4.5c-7.3 0-13.6 4.1-16.7 10.2z"
      />
      <path
        fill="#4CAF50"
        d="M24 43.5c5.1 0 9.7-1.9 13.2-5.1l-6.1-5c-2 1.4-4.5 2.1-7.1 2.1-5.3 0-9.7-3.1-11.3-7.4l-6.5 5C9.9 39.4 16.4 43.5 24 43.5z"
      />
      <path
        fill="#1976D2"
